          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center text-primary-foreground">
            <div className="space-y-2">
              ...
              <p className="max-w-[700px] md:text-xl/relaxed">
                At Varni Consultancy, we're here to help you achieve your
                business goals. Get in touch with us today to learn how we can
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <LocateIcon className="mt-1 h-5 w-5 text-muted-foreground" />
                <div>
                  <p className="font-medium">Varni Consultancy</p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="font-medium">info@varnicons.com</p>
                  <p className="text-muted-foreground">
