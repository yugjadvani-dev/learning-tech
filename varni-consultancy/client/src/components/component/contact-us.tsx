...
* @see https://v0.dev/t/dP9eaZSPZuf
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center text-primary-foreground">
            <div className="space-y-2">
              ...
              <p className="max-w-[700px] md:text-xl/relaxed">
                At Varni Consultancy, we're here to help you achieve your business goals. Get in touch with us today to
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Get in touch with us via email</p>
                </div>
              </div>
            </div>
          </div>
