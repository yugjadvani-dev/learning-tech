      ...
      <div className="container flex flex-1 gap-8 px-4 py-8 md:px-6">
        <aside className="hidden w-64 flex-col gap-6 md:flex">
          ...
          <div className="grid gap-2">
            ...
            <Input type="text" placeholder="Search movies..." className="w-full" />
          </div>
        </aside>
        <div className="flex-1">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div className="relative group">
              ...
              />
              <div className="flex flex-col items-start gap-2 p-4">
                <h3 className="text-lg font-semibold">The Lord of the Rings: The Fellowship of the Ring</h3>
                <div className="flex items-center gap-2">
                  <StarIcon className="w-5 h-5 fill-primary" />
                  <span className="text-sm font-medium">8.8</span>
                </div>
            ...
            <div className="relative group">
              ...
              />
              <div className="flex flex-col items-start gap-2 p-4">
                <h3 className="text-lg font-semibold">The Silence of the Lambs</h3>
                <div className="flex items-center gap-2">
                  <StarIcon className="w-5 h-5 fill-primary" />
