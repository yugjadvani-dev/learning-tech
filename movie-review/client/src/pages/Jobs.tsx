        ...
        <div className="container px-4 md:px-6 text-center">
          <div className="space-y-4">
            ...
            <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              ...
              future of movie reviews. Explore our open positions and apply
              today.
            </p>
          </div>
        </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Lead the development of our cutting-edge movie review
                  platform.
                </CardDescription>
              </CardHeader>
              <CardFooter>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Develop and implement our content strategy for movie reviews.
                </CardDescription>
              </CardHeader>
              <CardFooter>
                <Link
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Drive our online marketing efforts and grow our audience.
                </CardDescription>
              </CardHeader>
              <CardFooter>
                <Link
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Craft engaging video content to accompany our movie reviews.
                </CardDescription>
              </CardHeader>
              <CardFooter>
                <Link
