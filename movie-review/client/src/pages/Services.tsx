          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex flex-col items-start space-y-4 p-6 bg-card rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground">
                Get in-depth reviews from our expert critics to help you choose
                the perfect movie.
              </p>
            </div>
            <div className="flex flex-col items-start space-y-4 p-6 bg-card rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground">
                Discover movies with the highest ratings from our community of
                movie lovers.
              </p>
            </div>
            <div className="flex flex-col items-start space-y-4 p-6 bg-card rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground">
                Get tailored movie recommendations based on your viewing history
                and preferences.
              </p>
            </div>
            <div className="flex flex-col items-start space-y-4 p-6 bg-card rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground">
                Create and manage your own personalized watchlists to keep track
