...
const FrameComponent1 = ({
  ...
  return (
    <section
      className={`w-full relative flex flex-row items-start justify-center pt-0 px-5 pb-[177px] box-border max-w-full text-left text-21xl text-midnightblue-100 font-monument-extended mq750:pb-[115px] mq750:box-border ${className}`}
    >
            ...
            <div className="flex flex-row items-start justify-start py-0 px-1.5">
              <div className="flex flex-row items-start justify-start gap-[15px]">
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src="/icbaselinefacebook1.svg"
                />
                <img
                  className="h-[47px] w-[47px] relative overflow-hidden shrink-0 min-h-[47px] z-[2]"
                  loading="lazy"
                  alt=""
                  src="/mdifacebookmessenger1.svg"
                />
                <img
                  className="h-[47px] w-[47px] relative overflow-hidden shrink-0 min-h-[47px] z-[2]"
                  loading="lazy"
                  alt=""
                  src="/phinstagramlogofill1.svg"
                />
              </div>
            </div>
          </div>
