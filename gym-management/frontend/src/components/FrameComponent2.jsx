...
const FrameComponent2 = ({
  ...
  return (
    <section
      className={`w-full relative flex flex-row items-start justify-end py-0 pl-0 pr-[3px] box-border max-w-full text-left text-21xl text-white font-monument-extended ${className}`}
    >
            ...
            <div className="flex flex-row items-start justify-start py-0 px-0.5">
              <div className="flex flex-row items-start justify-start gap-[18px]">
                <ClearEntries
                  ...
                  propMinWidth="75px"
                />
                <ClearEntries clearEntries="Clear Entries" />
              </div>
            </div>
          </form>
        </div>
