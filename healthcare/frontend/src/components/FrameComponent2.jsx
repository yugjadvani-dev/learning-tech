...
const FrameComponent2 = ({
  ...
  return (
    <div
      className={`self-stretch flex flex-col items-end justify-start gap-[35px] max-w-full text-center text-xl text-white font-poppins mq750:gap-[17px] ${className}`}
    >
      <div className="self-stretch flex flex-row items-start justify-center py-0 pl-[22px] pr-5 box-border max-w-full">
        <div className="w-[566px] flex flex-col items-start justify-start max-w-full">
          <div className="self-stretch bg-darkslateblue-100 flex flex-row items-start justify-center pt-[41px] pb-[26px] pl-[34px] pr-5 box-border max-w-full z-[1]">
            <div className="h-[97px] w-[566px] relative bg-darkslateblue-100 hidden max-w-full" />
            <b className="w-[372px] relative inline-block shrink-0 max-w-full z-[2] mq450:text-base">
              I Have Healthcare Now What?
            </b>
          </div>
          <div className="self-stretch bg-aliceblue-400 flex flex-row items-start justify-center pt-[119px] pb-9 pl-7 pr-5 box-border max-w-full mt-[-94px] mq450:pb-[23px] mq450:box-border">
            <div className="h-[359px] w-[566px] relative bg-aliceblue-400 hidden max-w-full" />
            <img
