...
const Footer1= ({ className = "" }) => {
  return (
    <footer
      className={`self-stretch h-[819px] flex flex-col items-start justify-start pt-0 px-0 pb-[642px] box-border max-w-full text-center text-2xl text-white font-poppins mq750:pb-[271px] mq750:box-border mq1275:h-auto mq1275:pb-[417px] mq1275:box-border ${className}`}
    >
      <div className="ml-[-5px] self-stretch flex flex-row items-start justify-end py-[58px] px-[546px] box-border relative bg-[url('/public/rectangle-521@2x.png')] bg-cover bg-no-repeat bg-[top] shrink-0 max-w-[102%] mq750:pl-[136px] mq750:pr-[136px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border mq1275:pl-[273px] mq1275:pr-[273px] mq1275:box-border">
        <img
      ...
      <div className="ml-[-9px] self-stretch bg-gray-500 flex flex-col items-start justify-start pt-10 pb-5 pl-[164px] pr-[142px] box-border shrink-0 max-w-[102%] z-[4] mt-[-11px] text-left mq750:pl-[82px] mq750:pr-[71px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border">
        ...
        />
        <div className="self-stretch flex flex-row items-start justify-start gap-[79px] max-w-full mq750:gap-5 mq1275:flex-wrap mq1275:gap-[39px]">
          <div className="w-[308px] flex flex-col items-start justify-start pt-[17px] px-0 pb-0 box-border min-w-[308px] mq1275:flex-1">
          ...
          <div className="flex-1 flex flex-row items-start justify-start gap-[17px] min-w-[497px] max-w-full text-center mq750:flex-wrap mq1100:min-w-full">
