import Docterbox from "./Docterbox";
...
const FrameComponent4= ({
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-end py-0 pl-0 pr-0.5 box-border max-w-full text-center text-base text-white font-poppins ${className}`}
    >
      <div className="flex-1 bg-aliceblue-300 flex flex-row items-start justify-center py-[46px] pl-[21px] pr-5 box-border gap-[19.5px] max-w-full mq450:pt-[30px] mq450:pb-[30px] mq450:box-border mq1250:flex-wrap">
        <div className="h-[470px] w-[1438px] relative bg-aliceblue-300 hidden max-w-full" />
        <Docterbox
