...
const Footer2= ({ className = "" }) => {
  return (
    <footer
      className={`self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[642px] box-border max-w-full text-left text-2xl text-white font-poppins mq750:pb-[417px] mq750:box-border ${className}`}
    >
      <div className="ml-[-9px] self-stretch bg-gray-500 flex flex-col items-start justify-start pt-10 pb-5 pl-[164px] pr-[142px] box-border max-w-[102%] shrink-0 z-[4] mq750:pl-[82px] mq750:pt-[26px] mq750:pr-[71px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border">
        <a href="/about" className="w-[79px] relative leading-[34px] hidden mq450:text-mid mq450:leading-[27px]">
          About
        </a>
        ...
        />
        <div className="self-stretch flex flex-row items-start justify-start gap-[79px] max-w-full mq750:gap-5 mq1225:flex-wrap mq1225:gap-[39px]">
          <div className="w-[308px] flex flex-col items-start justify-start pt-[17px] px-0 pb-0 box-border min-w-[308px] mq1225:flex-1">
          ...
          <div className="flex-1 flex flex-row items-start justify-start gap-[17px] min-w-[497px] max-w-full text-center mq750:flex-wrap mq1050:min-w-full">
      ...
      <div className="ml-[-5px] self-stretch h-[-654px] flex flex-row items-end justify-start pt-0 px-[5px] pb-0 box-border bg-[url('/public/rectangle-521@2x.png')] bg-cover bg-no-repeat bg-[top] max-w-[102%] shrink-0 text-center">
        <img
          className="w-[1452px] relative max-h-full object-cover hidden max-w-full"
          alt=""
          src="/rectangle-521@2x.png"
        />
        <div className="flex-1 flex flex-row items-start justify-end py-[58px] px-[534px] box-border relative max-w-full mq750:pl-[133px] mq750:pr-[133px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border mq1225:pl-[267px] mq1225:pr-[267px] mq1225:box-border">
