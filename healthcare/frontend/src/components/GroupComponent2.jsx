...
const GroupComponent2= ({
  ...
  return (
    <footer
      className={`ml-[-9px] self-stretch bg-gray-500 flex flex-col items-start justify-start pt-10 pb-5 pl-[164px] pr-[142px] box-border max-w-[102%] shrink-0 z-[4] text-left text-2xl text-white font-poppins mq450:pl-5 mq450:pr-5 mq450:box-border mq750:pl-[82px] mq750:pt-[26px] mq750:pr-[71px] mq750:box-border ${className}`}
    >
      ...
      <div className="self-stretch flex flex-row items-start justify-start gap-[79px] max-w-full mq750:gap-5 mq1225:flex-wrap mq1225:gap-[39px]">
        <div className="w-[308px] flex flex-col items-start justify-start pt-[17px] px-0 pb-0 box-border min-w-[308px] mq1225:flex-1">
          <div className="self-stretch flex flex-col items-start justify-start gap-[49px] mq450:gap-6">
            <a href="/about" className="[text-decoration:none] w-[79px] relative leading-[34px] font-bold text-[inherit] inline-block z-[1] mq450:text-mid mq450:leading-[27px]">
              About
            </a>
        ...
        <div className="flex-1 flex flex-row items-start justify-start gap-[17px] min-w-[497px] max-w-full text-center mq1050:min-w-full mq750:flex-wrap">
