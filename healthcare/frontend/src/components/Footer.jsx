...
const Footer = ({ className = "" }) => {
  return (
    <footer
      className={`self-stretch flex flex-row items-start justify-between pt-[167px] pb-0 pl-[147px] pr-[142px] box-border max-w-full gap-5 text-left text-2xl text-white font-poppins mq450:pl-5 mq450:pr-5 mq450:box-border mq750:pl-[73px] mq750:pt-[109px] mq750:pr-[71px] mq750:box-border mq1250:flex-wrap mq1250:justify-center ${className}`}
    >
      <div className="flex flex-col items-start justify-start pt-[17px] px-0 pb-0">
        <div className="flex flex-col items-start justify-start gap-[49.5px]">
          <a href="/about" className="w-[79px] relative leading-[34px] inline-block z-[5] mq450:text-mid mq450:leading-[27px] text-white">
          <b>About</b>
          </a>
          <a href="/contact-us" className="w-[143px] relative leading-[34px] inline-block z-[5] mq450:text-mid mq450:leading-[27px] text-white">
            <b>Contact Us</b>
          </a>
          <a href="/privacy-policy" className="relative leading-[34px] z-[5] mq450:text-mid mq450:leading-[27px] text-white">
            Privacy Policy
          </a>
        </div>
      </div>
          ...
          <div className="self-stretch flex flex-row items-start justify-start py-0 pl-0.5 pr-0 box-border max-w-full text-left text-base">
            <div className="flex-1 flex flex-row items-start justify-start relative max-w-full">
              ...
              <div className="h-[662px] w-[1457px] absolute !m-[0] top-[-221px] left-[-942px]">
                <div className="absolute top-[0px] left-[0px] bg-gray-500 w-full h-full z-[4]" />
                <img
