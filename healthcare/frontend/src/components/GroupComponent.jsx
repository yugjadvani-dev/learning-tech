...
const GroupComponent = ({
  ...
  return (
    <section
      className={`mr-[-3px] mb-[55px] self-stretch [background:linear-gradient(89.98deg,_#125490,_rgba(21,_52,_81,_0)_39.58%,_#153451_70.83%)] flex flex-row items-end justify-center py-0 pl-[127px] pr-[5px] box-border max-w-[101%] shrink-0 [row-gap:20px] text-left text-2xl text-white font-poppins mq450:pl-5 mq450:box-border mq750:pl-[63px] mq750:box-border mq1250:flex-wrap ${className}`}
    >
      ...
      <div className="h-[509px] w-[25px] relative bg-khaki-100 z-[3] mq1250:hidden" />
      <div className="flex-1 flex flex-col items-start justify-start py-0 pl-0 pr-[118px] box-border min-w-[510px] max-w-full mq450:pr-5 mq450:box-border mq750:min-w-full mq1100:pr-[59px] mq1100:box-border">
        <div className="w-[392px] bg-steelblue-800 flex flex-row items-start justify-start pt-[26px] pb-[21px] pl-[33px] pr-[19px] box-border max-w-full z-[2]">
          <div className="h-[115px] w-[392px] relative bg-steelblue-800 hidden max-w-full" />
        ...
        <div className="self-stretch flex flex-row items-start justify-between gap-5 mq750:flex-wrap">
          <div className="w-[294px] bg-darkslategray-600 flex flex-row items-start justify-start pt-[33px] px-[33px] pb-[31px] box-border min-w-[294px] z-[1] mq750:flex-1">
            <div className="h-[337px] w-[294px] relative bg-darkslategray-600 hidden" />
      ...
      <div className="w-[512px] flex flex-col items-start justify-start pt-0 px-0 pb-[90px] box-border min-h-[392px] max-w-full text-right text-base mq450:pb-[58px] mq450:box-border mq1250:flex-1">
        <div className="self-stretch bg-darkslateblue-100 flex flex-row items-start justify-start py-[30px] px-[51px] box-border min-h-[302px] max-w-full z-[1] mq750:pl-[25px] mq750:pr-[25px] mq750:box-border">
          <div className="h-[302px] w-[512px] relative bg-darkslateblue-100 hidden max-w-full" />
