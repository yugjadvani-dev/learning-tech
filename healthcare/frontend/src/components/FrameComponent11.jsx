...
const FrameComponent11= ({
  ...
  return (
    <footer
      className={`self-stretch h-[819px] flex flex-col items-start justify-start pt-0 px-0 pb-[642px] box-border max-w-full text-center text-2xl text-white font-poppins mq1275:h-auto ${className}`}
    >
      ...
      <div className="ml-[-9px] self-stretch bg-gray-500 flex flex-col items-start justify-start pt-10 pb-5 pl-[164px] pr-[142px] box-border shrink-0 max-w-[102%] z-[4] mt-[-15px] text-left mq750:pl-[82px] mq750:pr-[71px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border">
