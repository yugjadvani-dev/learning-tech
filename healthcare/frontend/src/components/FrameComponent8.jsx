...
const FrameComponent8= ({
  ...
  return (
    <div
      className={`w-[1162px] flex flex-row items-start justify-start py-0 px-[7px] box-border max-w-full ${className}`}
    >
      <div className="flex-1 flex flex-row items-end justify-between gap-5 max-w-full">
        <img
        ...
        />
        <div className="w-[498px] flex flex-col items-start justify-end pt-0 pb-[17px] pl-0 pr-7 box-border max-w-full mq1100:w-7">
          <nav className="m-0 self-stretch flex flex-row items-start justify-start gap-5 text-center text-mid text-steelblue-400 font-poppins mq1100:hidden">
