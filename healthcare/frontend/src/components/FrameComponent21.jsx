...
const FrameComponent21 = ({
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[177px] box-border max-w-full text-left text-xl text-darkslateblue-100 font-poppins mq1125:pb-[115px] mq1125:box-border mq450:pb-[75px] mq450:box-border ${className}`}
    >
      <div className="flex-1 bg-aliceblue-300 flex flex-row items-start justify-center py-9 px-5 box-border min-h-[654px] max-w-full mq800:pt-[23px] mq800:pb-[23px] mq800:box-border">
        <div className="h-[654px] w-[1440px] relative bg-aliceblue-300 hidden max-w-full" />
        <div className="w-[1156px] bg-white flex flex-col items-start justify-start pt-[52px] px-[101px] pb-[45px] box-border gap-[72px] max-w-full z-[1] mq800:gap-[18px] mq800:pt-[34px] mq800:px-[25px] mq800:pb-[29px] mq800:box-border mq1125:gap-9 mq1125:pl-[50px] mq1125:pr-[50px] mq1125:box-border">
          ...
          <div className="w-[875px] flex flex-row items-start justify-between max-w-full gap-5 text-lgi text-darkslateblue-200 mq1125:flex-wrap">
            <div className="w-[362px] flex flex-col items-start justify-start pt-1.5 px-0 pb-0 box-border min-w-[362px] max-w-full mq800:min-w-full mq1125:flex-1">
            ...
            <div className="w-[389px] flex flex-col items-end justify-start gap-[86px] min-w-[389px] max-w-full mq800:min-w-full mq1125:flex-1 mq450:gap-[43px]">
              <div className="self-stretch flex flex-row items-start justify-end py-0 pl-0 pr-[27px] box-border max-w-full">
                <div className="flex-1 flex flex-col items-start justify-start gap-9 max-w-full mq1125:flex-1 mq450:gap-[18px]">
                  <div className="self-stretch flex flex-col items-start justify-start gap-[19px] max-w-full">
