...
const Footer3 = ({ className = "" }) => {
  return (
    <footer
      className={`self-stretch flex flex-col items-start justify-start min-h-[662px] max-w-full text-left text-2xl text-white font-poppins ${className}`}
    >
      <div className="ml-[-9px] self-stretch bg-gray-500 flex flex-col items-start justify-start pt-10 pb-5 pl-[164px] pr-[142px] box-border max-w-[102%] shrink-0 z-[4] mq825:pl-[82px] mq825:pt-[26px] mq825:pr-[71px] mq825:box-border mq450:pl-5 mq450:pr-5 mq450:box-border">
        ...
        />
        <div className="self-stretch flex flex-row items-start justify-start gap-[79px] max-w-full mq825:gap-5 mq1125:gap-[39px] mq1400:flex-wrap">
          <div className="w-[308px] flex flex-col items-start justify-start pt-[17px] px-0 pb-0 box-border min-w-[308px] mq1400:flex-1">
          ...
          <div className="flex-1 flex flex-row items-start justify-start gap-[17px] min-w-[497px] max-w-full text-center mq825:flex-wrap mq1125:min-w-full">
      ...
      <div className="ml-[-5px] self-stretch h-[-642px] flex flex-row items-end justify-start pt-0 px-[5px] pb-0 box-border bg-[url('/public/rectangle-521@2x.png')] bg-cover bg-no-repeat bg-[top] max-w-[102%] shrink-0 text-center">
        <img
          className="w-[1452px] relative max-h-full object-cover hidden max-w-full"
          alt=""
          src="/rectangle-521@2x.png"
        />
        <div className="flex-1 flex flex-row items-start justify-end py-[58px] px-[534px] box-border relative max-w-full mq825:pl-[133px] mq825:pr-[133px] mq825:box-border mq450:pl-5 mq450:pr-5 mq450:box-border mq1400:pl-[267px] mq1400:pr-[267px] mq1400:box-border">
