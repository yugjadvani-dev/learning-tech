...
const RequestQuote = ({
  ...
  return (
    ...
    >
      ...
      <footer className="ml-[-9px] self-stretch bg-gray-500 flex flex-col items-start justify-start pt-10 pb-5 pl-[164px] pr-[142px] box-border max-w-[102%] shrink-0 z-[4] mt-[-20px] text-left text-2xl text-white font-poppins mq450:pl-5 mq450:pr-5 mq450:box-border mq750:pl-[82px] mq750:pr-[71px] mq750:box-border">
