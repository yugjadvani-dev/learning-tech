...
const GroupComponent4 = ({
  ...
  return (
    ...
    >
      ...
      <div className="w-[1156px] bg-white flex flex-col items-start justify-start pt-[52px] px-[101px] pb-[45px] box-border gap-[72px] max-w-full z-[1] mq750:gap-[18px] mq750:pt-[34px] mq750:px-[25px] mq750:pb-[29px] mq750:box-border mq1100:gap-9 mq1100:pl-[50px] mq1100:pr-[50px] mq1100:box-border">
