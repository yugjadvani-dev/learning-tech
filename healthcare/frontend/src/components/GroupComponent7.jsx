...
const GroupComponent7 = ({
  ...
  return (
    <div
      className={`self-stretch bg-aliceblue-300 flex flex-row items-start justify-center py-9 px-5 box-border min-h-[654px] max-w-full text-left text-xl text-darkslateblue-100 font-poppins mq825:pt-[23px] mq825:pb-[23px] mq825:box-border ${className}`}
    >
      <div className="h-[654px] w-[1440px] relative bg-aliceblue-300 hidden max-w-full" />
      <div className="w-[1156px] bg-white flex flex-col items-start justify-start pt-[52px] px-[101px] pb-[45px] box-border gap-[72px] max-w-full z-[1] mq825:gap-[18px] mq825:pt-[34px] mq825:px-[25px] mq825:pb-[29px] mq825:box-border mq1125:gap-9 mq1125:pl-[50px] mq1125:pr-[50px] mq1125:box-border">
        ...
        <div className="w-[875px] flex flex-row items-start justify-between max-w-full gap-5 text-lgi text-darkslateblue-200 mq1125:flex-wrap">
          <div className="w-[362px] flex flex-col items-start justify-start pt-1.5 px-0 pb-0 box-border min-w-[362px] max-w-full mq825:min-w-full mq1125:flex-1">
            <div className="self-stretch flex flex-col items-start justify-start gap-[15px] max-w-full">
              <div className="w-[303px] flex flex-row items-start justify-start pt-0 px-0 pb-1 box-border">
          ...
          <div className="w-[389px] flex flex-col items-end justify-start gap-[86px] min-w-[389px] max-w-full mq825:min-w-full mq1125:flex-1 mq450:gap-[43px]">
