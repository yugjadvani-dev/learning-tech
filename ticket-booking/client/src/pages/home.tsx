    ...
    <div className="flex flex-col">
        ...
        <div className="container grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card>
            <CardContent className="flex flex-col items-center justify-center gap-4 p-8">
              ...
              <p className="text-muted-foreground text-center">
                Book your train tickets with ease and enjoy a comfortable journey.
              </p>
              <Link
                to="/"
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center gap-4 p-8">
              ...
              <p className="text-muted-foreground text-center">Book your flights with ease and enjoy your journey.</p>
              <Link
                to="/"
                className="inline-flex h-10 items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-8">
              We are a leading travel booking platform that provides seamless booking experiences for trains, buses, and
              flights. Our mission is to make travel planning easy and accessible for everyone.
            </p>
            <Link
              to="/"
              className="inline-flex h-10 items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  "I've been using this platform for all my travel bookings, and\n I'm always impressed by the seamless
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-muted-foreground text-sm">Frequent Traveler</p>
                  </div>
                </div>
                <p className="text-muted-foreground">
                  "I've been using this platform for all my travel bookings, and\n I'm always impressed by the seamless
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-muted-foreground text-sm">Business Traveler</p>
                  </div>
                </div>
                <p className="text-muted-foreground">
                  "I've been using this platform for all my travel bookings, and\n I'm always impressed by the seamless
      ...
      <section className="w-full py-12 md:py-16 lg:py-20 bg-muted">
        <div className="container max-w-2xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Subscribe to our newsletter to receive the latest updates, special offers, and news about our platform.
          </p>
